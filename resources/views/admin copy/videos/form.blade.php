<x-admin.layouts.app>
    <x-slot name="title">{{ isset($video) ? 'Edit' : 'Create' }} Video</x-slot>

    <x-admin.page-header title="{{ isset($video) ? 'Edit' : 'Create' }} Video" description="Add video content from YouTube, Vimeo, or upload" />
