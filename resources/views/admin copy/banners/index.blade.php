<x-admin.layouts.app>
    ...
    <x-admin.table>
        ...
        @empty
            <tr><td colspan="5"><x-admin.empty-state><x-slot name="title">No banners found</x-slot><x-slot name="action"><x-admin.button href="{{ route('admin.banners.create') }}">Create Banner</x-admin.button></x-slot></x-admin.empty-state></td></tr>
        @endforelse
    </x-admin.table>
