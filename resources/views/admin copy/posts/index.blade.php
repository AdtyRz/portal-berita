<x-admin.layouts.app>
    ...
    <x-admin.table>
        ...
        @empty
            <tr><td colspan="6"><x-admin.empty-state><x-slot name="title">No posts found</x-slot><x-slot name="action"><x-admin.button href="{{ route('admin.posts.create') }}">Create Post</x-admin.button></x-slot></x-admin.empty-state></td></tr>
        @endforelse
    </x-admin.table>
