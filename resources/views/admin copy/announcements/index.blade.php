<x-admin.layouts.app>
    ...
    <x-admin.table>
        ...
        @empty
            <tr><td colspan="5"><x-admin.empty-state><x-slot name="title">No announcements found</x-slot><x-slot name="action"><x-admin.button href="{{ route('admin.announcements.create') }}">Create Announcement</x-admin.button></x-slot></x-admin.empty-state></td></tr>
        @endforelse
    </x-admin.table>
