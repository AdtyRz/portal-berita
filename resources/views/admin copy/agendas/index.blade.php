<x-admin.layouts.app>
    ...
    <x-admin.table>
        ...
        @empty
            <tr><td colspan="5"><x-admin.empty-state><x-slot name="title">No agendas found</x-slot><x-slot name="action"><x-admin.button href="{{ route('admin.agendas.create') }}">Create Agenda</x-admin.button></x-slot></x-admin.empty-state></td></tr>
        @endforelse
    </x-admin.table>
