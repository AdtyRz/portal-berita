...
@section('metaDescription', $announcement->meta_description ?? Str::limit($announcement->excerpt, 160))
        ...
        <div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
            ...
            <header class="mb-8">
                @php
                    ...
                    $priorityLabels = ['low' => 'Low Priority', 'medium' => 'Medium Priority', 'high' => 'High Priority', 'urgent' => 'URGENT'];
                @endphp
                <x-admin.badge :variant="$priorityVariants[$announcement->priority]" size="sm">
            ...
            @if($announcement->expired_date)
                <div class="mt-10 p-4 bg-amber-50 border border-amber-200 rounded-xl flex items-center gap-3">
                    ...
                    <div class="text-sm text-amber-800">
                        <span class="font-semibold">Expires:</span> {{ $announcement->expired_date->format('F d, Y H:i') }}
                    </div>
                </div>
            @endif
