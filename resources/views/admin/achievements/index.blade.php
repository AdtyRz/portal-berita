...
@section('title', 'Achievements')
        ...
        <form method="GET" class="p-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('admin.achievements.create') }}" class="px-4 py-2 text-sm font-medium text-white bg-neutral-900 border border-neutral-900 rounded-lg hover:bg-neutral-800">Create New </a>
                </div>
            </div>
        </form>
    </x-admin.card>
    ...
    <x-admin.table>
        ...
        @empty
            <tr><td colspan="6"><x-admin.empty-state>@section('title', 'No achievements found')<x-slot name="action"><x-admin.button href="{{ route('admin.achievements.create') }}">Create Achievement</x-admin.button></x-slot></x-admin.empty-state></td></tr>
        @endforelse
    </x-admin.table>
