    ...
    <form method="POST" action="{{ route('admin.settings.update') }}" enctype="multipart/form-data" class="space-y-6">
        ...
        <x-admin.card>
            <div class="p-6 space-y-6">
                <h3 class="text-lg font-semibold text-neutral-900 dark:text-white flex items-center gap-2" style="font-family: var(--font-heading);">
                    <svg class="w-5 h-5 text-neutral-600 dark:text-neutral-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M14 10l-2 1m0 0l-2-1m2 1v7.5M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    Social Media Embed Codes (Maks. 2 per platform)
                </h3>
                
                <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <p class="text-sm text-blue-800 dark:text-blue-200 font-medium mb-2">💡 Cara Mendapatkan Embed Code:</p>
                    <ul class="text-xs text-blue-700 dark:text-blue-300 space-y-1 list-disc list-inside">
                        <li><strong>Instagram:</strong> Buka post → Klik ⋮ → <strong>Embed</strong> → Copy kode HTML</li>
                        <li><strong>TikTok:</strong> Buka video → Klik <strong>Share</strong> → <strong>Embed</strong> → Copy kode</li>
                        <li><strong>YouTube:</strong> Buka video → Klik <strong>Share</strong> → <strong>Embed</strong> → Copy iframe</li>
                        <li><strong>Facebook:</strong> Buka Page → Klik ··· → <strong>Embed</strong> → Copy kode</li>
                    </ul>
                </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 1</label>
                                <textarea name="instagram_embed_1" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste first Instagram embed code here...">{{ old('instagram_embed_1', $profile->instagram_embed_1 ?? '') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 2 (Optional)</label>
                                <textarea name="instagram_embed_2" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste second Instagram embed code here...">{{ old('instagram_embed_2', $profile->instagram_embed_2 ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 1</label>
                                <textarea name="tiktok_embed_1" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste first TikTok embed code here...">{{ old('tiktok_embed_1', $profile->tiktok_embed_1 ?? '') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 2 (Optional)</label>
                                <textarea name="tiktok_embed_2" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste second TikTok embed code here...">{{ old('tiktok_embed_2', $profile->tiktok_embed_2 ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 1</label>
                                <textarea name="youtube_embed_1" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste first YouTube iframe here...">{{ old('youtube_embed_1', $profile->youtube_embed_1 ?? '') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 2 (Optional)</label>
                                <textarea name="youtube_embed_2" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste second YouTube iframe here...">{{ old('youtube_embed_2', $profile->youtube_embed_2 ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 1</label>
                                <textarea name="facebook_embed_1" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste first Facebook embed code here...">{{ old('facebook_embed_1', $profile->facebook_embed_1 ?? '') }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-neutral-700 dark:text-neutral-300 mb-2">Embed Code 2 (Optional)</label>
                                <textarea name="facebook_embed_2" rows="4" class="w-full px-3.5 py-2 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-lg text-sm font-mono focus:outline-none focus:ring-2 focus:ring-neutral-900/10 focus:border-neutral-400" placeholder="Paste second Facebook embed code here...">{{ old('facebook_embed_2', $profile->facebook_embed_2 ?? '') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
